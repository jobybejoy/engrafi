...
<head>
    <meta charset="UTF-8">
    <title>Activate Account - Engrafi</title>
</head>
<body style="margin:0;">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td align="left" valign="top" style="padding-bottom:40px">
                                                                                    <h1 style="color:#737373;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:30px;font-style:normal;font-weight:600;line-height:42px;letter-spacing:normal;margin:0;padding:0;text-align:center">We're glad you're here <br> {{ $name }}.</h1>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td align="center" valign="top">
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td align="center" valign="middle">
                                                                                                    <a href="{{ env('APP_FRONTEND').'/user/verify/'. $confirmation_code }}" style="background-color:#00B0FF;border-collapse:separate;padding:20px 40px;background-color:#00B0FF;border-radius:3px;color:#ffffff;display:inline-block;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:16px;font-weight:600;letter-spacing:.3px;text-decoration:none" target="_blank" data-saferedirecturl="{{ env('APP_FRONTEND').'/user/verify/'. $confirmation_code }}">Activate Account</a>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </tbody>
                                                                                    </table>
                                                                            ...
                                                                            <tr>
                                                                                <td align="left" valign="top" style="padding-bottom:40px">
                                                                                    <p style="color:#929292;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:14px;font-style:normal;font-weight:400;line-height:42px;letter-spacing:normal;margin:0;padding:0;text-align:center">(Just confirming you're you.)</p>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
